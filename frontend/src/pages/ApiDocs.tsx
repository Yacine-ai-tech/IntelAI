...
{ "metric": "Revenue", "value": 1320000, "period": "2025-06" }`,
  ...
  },
  {
    ...
    desc: "Switch the database to a named benchmarking scenario (replaces all KPI data). Valid values: healthy, declining_financial, high_churn_crisis, operational_meltdown, talent_crisis, cybersecurity_breach, esg_compliance_failure.",
    bodyType: "json",
