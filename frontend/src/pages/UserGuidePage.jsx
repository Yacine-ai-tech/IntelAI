    ...
    <div className="p-8 max-w-5xl mx-auto h-full overflow-y-auto">
      <div className="flex items-center gap-3 mb-8">
        ...
        <h1 className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-600">
          IntelAI Vector & Data Store - User Guide
        </h1>
      </div>

      <p className="text-lg text-gray-300 mb-8 leading-relaxed">
        IntelAI is the core embedding and storage engine, providing high-performance semantic search and knowledge graph relationships using pgvector.
      </p>
        ...
        <section className="bg-gray-800/50 backdrop-blur-md p-8 rounded-xl border border-gray-700 shadow-2xl">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-900 p-4 rounded-lg border border-gray-700">
              <h3 className="font-semibold text-blue-400 text-lg mb-2">1. Reciprocal Rank Fusion (RRF)</h3>
              <p className="text-sm text-gray-300">Run hybrid searches (keyword BM25 + dense vector) against your document corpus, combined using advanced RRF algorithms for maximum accuracy.</p>
            </div>
            <div className="bg-gray-900 p-4 rounded-lg border border-gray-700">
              <h3 className="font-semibold text-purple-400 text-lg mb-2">2. Postgres pgvector</h3>
              <p className="text-sm text-gray-300">Manage the underlying connections to the Postgres pgvector database natively. Support for exact nearest neighbor (L2, Cosine) and HNSW indexing.</p>
            </div>
            <div className="bg-gray-900 p-4 rounded-lg border border-gray-700">
              <h3 className="font-semibold text-amber-400 text-lg mb-2">3. 9 Dynamic Personas</h3>
              <p className="text-sm text-gray-300">Automatically route conversational queries through 9 distinct Persona Routers based on the semantic intent of the user prompt.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-gray-800/50 backdrop-blur-md p-8 rounded-xl border border-gray-700 shadow-2xl">
          <h2 className="text-2xl font-bold mb-4 flex items-center gap-2 text-white">
            ...
            <div>
              ...
              <p className="text-sm text-gray-300 mb-3">To run IntelAI locally, ensure the following environment variables are set in your <code>.env</code> file:</p>
