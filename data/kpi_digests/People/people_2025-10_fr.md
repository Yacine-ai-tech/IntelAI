# People — Synthèse des indicateurs réels (2025-10)

Valeurs enregistrées pour les indicateurs People en 2025-10. Chaque chiffre est reproduit tel que publié par sa source ; l'identifiant de la source suit chaque ligne.

## Séries couvertes
- Salaire horaire moyen [External — US Market Context]: 37 USD  (source: fred:CES0500000003)
- Offres d'emploi [External — US Market Context]: 7,170.00 count  (source: fred:JTSJOL)
