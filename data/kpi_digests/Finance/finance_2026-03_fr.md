# Finance — Synthèse des indicateurs réels (2026-03)

Valeurs enregistrées pour les indicateurs Finance en 2026-03. Chaque chiffre est reproduit tel que publié par sa source ; l'identifiant de la source suit chaque ligne.

## Séries couvertes
- Indice des prix à la consommation [External — US Market Context]: 330.29 index  (source: fred:CPIAUCSL)
- Taux directeur effectif [External — US Market Context]: 3.64 %  (source: fred:FEDFUNDS)
