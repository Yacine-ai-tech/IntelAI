# Finance — Synthèse des indicateurs réels (2025-12)

Valeurs enregistrées pour les indicateurs Finance en 2025-12. Chaque chiffre est reproduit tel que publié par sa source ; l'identifiant de la source suit chaque ligne.

## Séries couvertes
- Indice des prix à la consommation [External — US Market Context]: 326.03 index  (source: fred:CPIAUCSL)
- Taux directeur effectif [External — US Market Context]: 3.72 %  (source: fred:FEDFUNDS)
