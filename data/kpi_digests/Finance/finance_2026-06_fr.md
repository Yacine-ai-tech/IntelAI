# Finance — Synthèse des indicateurs réels (2026-06)

Valeurs enregistrées pour les indicateurs Finance en 2026-06. Chaque chiffre est reproduit tel que publié par sa source ; l'identifiant de la source suit chaque ligne.

## Séries couvertes
- Indice des prix à la consommation [External — US Market Context]: 332.57 index  (source: fred:CPIAUCSL)
- Taux directeur effectif [External — US Market Context]: 3.63 %  (source: fred:FEDFUNDS)
